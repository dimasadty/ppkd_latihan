...
<body class="with-welcome-text">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">Change Level</div>
                <div class="card-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nama">Add More</label>
                            <input value="<?php echo $dataEdit['levelname'] ?>" type="text" class="form-control"
                                name="levelname" placeholder="level...">
                        </div>
                        <div class="mb-3">
                            <input name="edit" type="submit" class="btn btn-primary" value="submit">
                            <a href="/latihanujikom/pageslevel/index.php" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
                <?php } else { ?>
